          ...
          <DialogContent className={`sm:max-w-5xl h-[80vh] bg-white/20 backdrop-blur-md px-10 overflow-hidden`}>
            ...
            <form className="w-full flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="w-full pt-4">
                <Button type="submit" disabled={isPending} className="w-full text-white text-xl font-semibold uppercase p-6 rounded-xl bg-red-700 hover:bg-red-800 transition-colors disabled:opacity-50">
